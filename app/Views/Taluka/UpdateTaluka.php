...
<head>
    ...
    <title>Field Visit - अपडेट तालुका </title>
                ...
                <div class="card">
                  <div class="card-body basic-form">
                    <div class="card-wrapper border rounded-3">
                       <?php echo form_open('/UpdateTalukaPro', array('autocomplete' => 'off','class' => 'p-0 row')); ?>
                       <input type="hidden" name="id" value="<?= !empty($list['id']) ? $list['id'] : '' ?>">
                        ...
                        <div class="mb-4 mt-3 col-md-6">
                          ...
                          <input class="form-control AlphabetsOnlyWithSpace" id="taluka" name="taluka" type="text" placeholder="तालुका प्रविष्ठ करा." value="<?= $list['taluka'] ?? set_value('taluka'); ?>">
                        ...
                        <div class="row">
                            ...
                            <a href="<?= base_url(); ?>Taluka"><input class="btn btn-danger btn-square" type="button" value="Cancel"></a>
                            </div>
                        </div>
                      </form>
                    </div>
