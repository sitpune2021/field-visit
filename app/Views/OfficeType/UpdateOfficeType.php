...
<head>
    ...
    <title>Field Visit - अपडेट कार्यालय प्रकार </title>
                    ...
                    <div class="card-wrapper border rounded-3">
                       ...
                       <input type="hidden" name="id" value="<?= !empty($list['id']) ? $list['id'] : '' ?>">
                        ...
                        <div class="row">
                            ...
                            <a href="<?= base_url(); ?>officeTypeList"><input class="btn btn-danger btn-square" type="button" value="Cancel"></a>
                            </div>
                        </div>
                      </form>
                    </div>
