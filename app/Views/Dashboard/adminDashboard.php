...
<head>
    ...
    <title>Field Visit - Admin Dashboard</title>
              ...
              <div class="col-xl-4 proorder-xxl-1 col-sm-6 box-col-6">
                <div class="card welcome-banner">
                  <div class="card-header p-0 card-no-border">
                    <div class="welcome-card"><img class="w-100 img-fluid" src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/welcome-bg.png" alt=""/><img class="position-absolute img-1 img-fluid" src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/img-1.png" alt=""/><img class="position-absolute img-2 img-fluid" src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/img-2.png" alt=""/><img class="position-absolute img-3 img-fluid" src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/img-3.png" alt=""/><img class="position-absolute img-4 img-fluid" src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/img-4.png" alt=""/><img class="position-absolute img-5 img-fluid" src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/img-5.png" alt=""/></div>
                  </div>
                  <div class="card-body">
                    <div class="d-flex align-center">
                      <h1>Hello, Amirreza  <img src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/hand.png" alt=""/></h1>
                    </div>
                    ...
                    <div class="d-flex align-center justify-content-between"><a class="btn btn-pill btn-primary" href="#">Whats New!</a><span> 
                        <svg class="stroke-icon">
                          <use href="<?= base_url(); ?>/public/Backend-Assets/svg/icon-sprite.svg#watch"></use>
                    ...
                    <div class="d-flex align-center gap-3">
                      <h2>$4,875</h2><span class="text-primary">
                        ...
                        <svg class="stroke-icon stroke-primary">
                          <use href="<?= base_url(); ?>/public/Backend-Assets/svg/icon-sprite.svg#arrow-down"></use>
                        </svg></span>
                    </div>
                      ...
                      <li>
                        <div class="d-flex gap-2"> 
                          <div class="flex-shrink-0 bg-light-primary">
                            <svg class="stroke-icon">
                              <use href="<?= base_url(); ?>/public/Backend-Assets/svg/icon-sprite.svg#job-bag"></use>
                            </svg>
                          </div>
                      ...
                      <li>
                        <div class="d-flex gap-2"> 
                          <div class="flex-shrink-0 bg-light-secondary">
                            <svg class="stroke-icon">
                              <use href="<?= base_url(); ?>/public/Backend-Assets/svg/icon-sprite.svg#employees"></use>
                            </svg>
                          </div>
                          <div class="flex-grow-1"> 
                            <h3>30</h3>
                      ...
                      <li>
                        <div class="d-flex gap-2"> 
                          <div class="flex-shrink-0 bg-light-warning">
                            <svg class="stroke-icon">
                              <use href="<?= base_url(); ?>/public/Backend-Assets/svg/icon-sprite.svg#hours-work"></use>
                            </svg>
                          </div>
                          <div class="flex-grow-1"> 
                            <h3>40</h3>
                      ...
                      <table class="table display" style="width:100%">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td> 
                              <div class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0"><img src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/user/1.png" alt=""/></div>
                                <div class="flex-grow-1">
                          ...
                          <tr>
                            ...
                            <td> 
                              <div class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0"><img src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/user/2.png" alt=""/></div>
                                <div class="flex-grow-1">
                                  <h6>Naomi watson</h6>
                                </div>
                              </div>
                          ...
                          <tr>
                            ...
                            <td> 
                              <div class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0"><img src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/user/3.png" alt=""/></div>
                                <div class="flex-grow-1">
                                  <h6>Dann Petty</h6>
                                </div>
                              </div>
                      ...
                      <table class="table display table-bordernone" id="transaction" style="width:100%">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <div class="d-flex align-items-center gap-3">
                                <div class="flex-shrink-0"><img src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/icon/1.png" alt=""/></div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center gap-3">
                                <div class="flex-shrink-0"><img src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/icon/2.png" alt=""/></div>
                                <div class="flex-grow-1"><a href="product-page.html">
                                    <h6>Spring Bed</h6></a>
                                  <p>Bought item</p>
                                </div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center gap-3">
                                <div class="flex-shrink-0"><img src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/icon/3.png" alt=""/></div>
                                <div class="flex-grow-1"><a href="product-page.html">
                                    <h6>Long Dress</h6></a>
                                  <p>Bought item</p>
                                </div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center gap-3">
                                <div class="flex-shrink-0"><img src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/icon/4.png" alt=""/></div>
                                <div class="flex-grow-1"><a href="product-page.html">
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center gap-3">
                                <div class="flex-shrink-0"><img src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/icon/5.png" alt=""/></div>
                                <div class="flex-grow-1"><a href="product-page.html">
                                    <h6>Sofa Hauga</h6></a>
                                  <p>Item Sold</p>
                                </div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center gap-3">
                                <div class="flex-shrink-0"><img src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/icon/6.png" alt=""/></div>
                                <div class="flex-grow-1"><a href="product-page.html">
                  ...
                  <div class="card-body audit-log"> 
                    <ul> 
                      <li class="d-flex align-items-center gap-2">
                        <div class="flex-shrink-0 bg-success"><img src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/icon/checked.png" alt=""/></div>
                        <div class="flex-grow-1"><a href="product-page.html">
                      ...
                      <li class="d-flex align-items-center gap-2">
                        <div class="flex-shrink-0 bg-warning"><img src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/icon/danger.png" alt=""/></div>
                        <div class="flex-grow-1"><a href="product-page.html">
                      ...
                      <li class="d-flex align-items-center gap-2">
                        <div class="flex-shrink-0 bg-danger"><img src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/icon/cancel.png" alt=""/></div>
                        <div class="flex-grow-1"><a href="product-page.html">
                    ...
                    <ul> 
                      <li class="d-flex align-items-center gap-2">
                        <div class="flex-shrink-0 bg-light-primary border-light-primary">
                          <svg class="stroke-icon stroke-primary">
                            <use href="<?= base_url(); ?>/public/Backend-Assets/svg/icon-sprite.svg#box"></use>
                          </svg>
                        </div>
                        <div class="flex-grow-1"><a href="product-page.html">
                      ...
                      <li class="d-flex align-items-center gap-2">
                        <div class="flex-shrink-0 bg-light-warning border-light-warning">
                          <svg class="stroke-icon stroke-warning">
                            <use href="<?= base_url(); ?>/public/Backend-Assets/svg/icon-sprite.svg#dolar"></use>
                          </svg>
                        </div>
                        <div class="flex-grow-1"><a href="product-page.html">
                      ...
                      <li class="d-flex align-items-center gap-2">
                        <div class="flex-shrink-0 bg-light-danger border-light-danger">
                          <svg class="stroke-icon stroke-danger">
                            <use href="<?= base_url(); ?>/public/Backend-Assets/svg/icon-sprite.svg#round-right"></use>
                          </svg>
                        </div>
                        <div class="flex-grow-1"><a href="product-page.html">
                            <h6>Review</h6></a>
                      ...
                      <li class="d-flex align-items-center gap-2">
                        <div class="flex-shrink-0 bg-light-primary border-light-primary">
                          <svg class="stroke-icon stroke-primary">
                            <use href="<?= base_url(); ?>/public/Backend-Assets/svg/icon-sprite.svg#pie-chart"></use>
                          </svg>
                        </div>
                        <div class="flex-grow-1"><a href="product-page.html">
                      ...
                      <li class="d-flex align-items-center gap-2">
                        <div class="flex-shrink-0 bg-light-warning border-light-warning">
                          <svg class="stroke-icon stroke-warning">
                            <use href="<?= base_url(); ?>/public/Backend-Assets/svg/icon-sprite.svg#globe"></use>
                          </svg>
                        </div>
                        <div class="flex-grow-1"><a href="product-page.html">
                      ...
                      <li class="d-flex align-items-center gap-2">
                        <div class="flex-shrink-0 bg-light-danger border-light-danger">
                          <svg class="stroke-icon stroke-none">
                            <use href="<?= base_url(); ?>/public/Backend-Assets/svg/icon-sprite.svg#box-user"></use>
                          </svg>
                        </div>
                        <div class="flex-grow-1"><a href="product-page.html">
                      ...
                      <li class="d-flex align-items-center gap-2">
                        <div class="flex-shrink-0 bg-light-primary border-light-primary">
                          <svg class="stroke-icon stroke-primary">
                            <use href="<?= base_url(); ?>/public/Backend-Assets/svg/icon-sprite.svg#work-bag"></use>
                          </svg>
                        </div>
                        <div class="flex-grow-1"><a href="product-page.html">
                            <h6>Added new work</h6></a>
                  ...
                  <div class="card-body top-user pt-2">
                    <ul>
                      <li class="d-flex align-items-center justify-content-between gap-2"> 
                        <div class="d-flex gap-2">
                          <div class="flex-shrink-0 comman-round"><img src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/user/01.png" alt=""/></div>
                          <div><a href="#"> 
                              <h6>Alice Goodwin</h6></a>
                            <p> 
                              <svg class="stroke-icon">
                                <use href="<?= base_url(); ?>/public/Backend-Assets/svg/icon-sprite.svg#map-icon"></use>
                              </svg>Texas
                            </p>
                          </div>
                        </div>
                      ...
                      <li class="d-flex align-items-center justify-content-between gap-2"> 
                        <div class="d-flex gap-2">
                          <div class="flex-shrink-0 comman-round"><img src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/user/02.png" alt=""/></div>
                          <div><a href="#"> 
                      ...
                      <li class="d-flex align-items-center justify-content-between gap-2"> 
                        <div class="d-flex gap-2">
                          <div class="flex-shrink-0 comman-round"><img src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/user/03.png" alt=""/></div>
                          <div><a href="#"> 
                      ...
                      <li class="d-flex align-items-center justify-content-between gap-2"> 
                        <div class="d-flex gap-2">
                          <div class="flex-shrink-0 comman-round"><img src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/user/04.png" alt=""/></div>
                          <div><a href="#"> 
                              <h6>Brown Acum</h6></a>
                            <p> 
                              <svg class="stroke-icon">
                      ...
                      <li class="d-flex align-items-center justify-content-between gap-2"> 
                        <div class="d-flex gap-2">
                          <div class="flex-shrink-0 comman-round"><img src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/user/05.png" alt=""/></div>
                          <div><a href="#"> 
                              <h6>Evans Mayo</h6></a>
                            <p> 
                              <svg class="stroke-icon">
                      ...
                      <li class="d-flex align-items-center justify-content-between gap-2"> 
                        <div class="d-flex gap-2">
                          <div class="flex-shrink-0 comman-round"><img src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/user/06.png" alt=""/></div>
                          <div><a href="#"> 
                      ...
                      <li class="d-flex align-items-center justify-content-between gap-2"> 
                        <div class="d-flex gap-2">
                          <div class="flex-shrink-0 comman-round"><img src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/user/07.png" alt=""/></div>
                          <div><a href="#"> 
                  ...
                  <div class="card-body news-update"> 
                    <ul> 
                      <li class="d-flex gap-2"> 
                        <div class="flex-shrink-0"><img class="img-fluid" src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/news-update/1.png" alt=""/></div>
                      ...
                      <li class="d-flex gap-2"> 
                        <div class="flex-shrink-0"><img class="img-fluid" src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/news-update/2.png" alt=""/></div>
                        <div class="flex-grow-1"> <a href="private-chat.html"> 
                      ...
                      <li class="d-flex gap-2"> 
                        <div class="flex-shrink-0"><img class="img-fluid" src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/news-update/3.png" alt=""/></div>
                        <div class="flex-grow-1"> <a href="private-chat.html"> 
                      ...
                      <li class="d-flex gap-2"> 
                        <div class="flex-shrink-0"><img class="img-fluid" src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/news-update/4.png" alt=""/></div>
                        <div class="flex-grow-1"> <a href="private-chat.html"> 
                      ...
                      <li class="d-flex gap-2"> 
                        <div class="flex-shrink-0"><img class="img-fluid" src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/news-update/5.png" alt=""/></div>
                        <div class="flex-grow-1"> <a href="private-chat.html"> 
                            <h6>Business project research</h6></a>
                      ...
                      <li class="d-flex gap-2"> 
                        <div class="flex-shrink-0"><img class="img-fluid" src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/news-update/6.png" alt=""/></div>
                        <div class="flex-grow-1"> <a href="private-chat.html"> 
                      ...
                      <li class="d-flex gap-2"> 
                        <div class="flex-shrink-0"><img class="img-fluid" src="<?= base_url(); ?>/public/Backend-Assets/images/dashboard-1/news-update/7.png" alt=""/></div>
                        <div class="flex-grow-1"> <a href="private-chat.html"> 
                            <h6>Added new work</h6></a>
                          <p class="text-truncate">Today’s news headlines,Breaking...</p>
                  ...
                  <div class="card-body total-invest">
                    <div class="row"> 
                      ...
                      <div class="col-6 col-md-12 invest-content text-center">
                        <svg class="stroke-icon">
                          <use href="<?= base_url(); ?>/public/Backend-Assets/svg/icon-sprite.svg#chart-invest"></use>
                        </svg>
