...
<head>
    ...
    <title>Field Visit - अपडेट कार्यालय </title>
                ...
                <div class="card">
                  <div class="card-body basic-form">
                    <div class="card-wrapper border rounded-3">
                       <?php echo form_open('/updateOfficePro', array('autocomplete' => 'off','class' => 'p-0 row')); ?>
                       ...
                       <div class="col-md-6 mb-3">
                          ...
                          <?php $talukaid = $list['taluka'] ?? set_value('taluka'); ?>
                       ...
                       <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                          ...
                          <input class="form-control AlphabetsOnlyWithSpace" id="office" name="office" type="text" placeholder="कार्यालय प्रविष्ठ करा." value="<?= $list['office'] ?? set_value('office'); ?>">
                        ...
                        <div class="row">
                            ...
                            <a href="<?= base_url(); ?>officeList"><input class="btn btn-danger btn-square" type="button" value="Cancel"></a>
                            </div>
                        </div>
                      </form>
                    </div>
